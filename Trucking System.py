...
# =============================================================================
# 7. DRIVER PAGE WITH AUTO-GPS TRACKING (UPDATED)
# =============================================================================
def driver_page():
    ...
    # Map Rendering
    origin_node = {"name": "Your Current Location", "lat": driver_coords["latitude"], "lng": driver_coords["longitude"]} if driver_coords else depot_node()
